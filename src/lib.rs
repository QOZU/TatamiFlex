...
#[derive(Debug)]
pub struct TatamiFlexProcessor {
    verbose: bool,
    processed_count: usize,
}

impl TatamiFlexProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting TatamiFlex processing");
    
    let mut processor = TatamiFlexProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = TatamiFlexProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = TatamiFlexProcessor::new(false);
